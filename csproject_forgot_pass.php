								...
								<!-- Main Content -->
									<section>
										...
										<p> <font size="5px" face="Calibri">  
											...
											<form action = "csproject_retrieve_password.php" method = "POST">
												Please enter your username:
												<br>
												<br>
												Username: <input type = "text" name = "username"><br><br>
												
												<input type = "submit" name = "retrievePass"  value = "Retrieve password">
											</form>
											</li>
											<br>
											<br>
									...
									<p><div align = "center"><div align = "center"><br><br></div></p>		
									</section>
							</div>
						</div>
					</div>
